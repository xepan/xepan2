...
$.widget("ui.atk4_uploader", {
	...
	upload: function(){
		...
		var g=$('<div class="atk-loader xepan-image-uploading" id="'+this.name+'_progress"><i></i><img src="templates/images/xepan-image-uploading.gif"/>Uploading '+this.element.val()+'</div>')
