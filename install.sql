...
) ENGINE=InnoDB AUTO_INCREMENT=5471 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=314349 DEFAULT CHARSET=utf8;
...
CREATE TABLE `blog_comment` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1106 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=1195 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=653377 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=22195 DEFAULT CHARSET=utf8mb4;
...
) ENGINE=InnoDB AUTO_INCREMENT=145353 DEFAULT CHARSET=utf8;
...
CREATE TABLE `contact_info` (
  ...
  KEY `value` (`value`),
  KEY `head` (`head`)
) ENGINE=InnoDB AUTO_INCREMENT=151571 DEFAULT CHARSET=utf8;
...
CREATE TABLE `custom_form_submission` (
  ...
  `created_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=299 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE `document` (
  ...
  FULLTEXT KEY `search_string` (`search_string`)
) ENGINE=InnoDB AUTO_INCREMENT=7217 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=5654 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `employee_movement` (
  ...
  PRIMARY KEY (`id`),
  KEY `employee_id` (`employee_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=15025 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=9696 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=557 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE `filestore_type` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=900 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE `lead_category_association` (
  ...
  KEY `marketing_category_id` (`marketing_category_id`),
  KEY `created_at` (`created_at`)
) ENGINE=InnoDB AUTO_INCREMENT=1917527 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `list` (
  ...
  `list_data_print_layout` text,
  `related_list_data_print_layout` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=10058 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=57334 DEFAULT CHARSET=utf8;
