...
) ENGINE=InnoDB AUTO_INCREMENT=314481 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=653442 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=22196 DEFAULT CHARSET=utf8mb4;
...
) ENGINE=InnoDB AUTO_INCREMENT=145432 DEFAULT CHARSET=utf8;
...
CREATE TABLE `contact_info` (
  ...
  KEY `value` (`value`),
  KEY `head` (`head`)
) ENGINE=InnoDB AUTO_INCREMENT=151716 DEFAULT CHARSET=utf8;
...
CREATE TABLE `employee_movement` (
  ...
  PRIMARY KEY (`id`),
  KEY `employee_id` (`employee_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=15080 DEFAULT CHARSET=utf8;
...
CREATE TABLE `lead_category_association` (
  ...
  KEY `marketing_category_id` (`marketing_category_id`),
  KEY `created_at` (`created_at`)
) ENGINE=InnoDB AUTO_INCREMENT=1917578 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
