...
--
-- Host: localhost
-- Generation Time: Oct 24, 2016 at 06:42 PM
...
ALTER TABLE `campaign` ADD FULLTEXT KEY `search_string` (`title`);
...
--
-- Indexes for table `dispatch_barcode`
--
ALTER TABLE `dispatch_barcode`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `employee_attandance`
--
ALTER TABLE `employee_attandance`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `employee_leave_allow`
--
ALTER TABLE `employee_leave_allow`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `filestore_file`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_filestore_file_filestore_type1_idx` (`filestore_type_id`),
  ADD KEY `fk_filestore_file_filestore_volume1_idx` (`filestore_volume_id`);
...
ALTER TABLE `filestore_image`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_filestore_image_filestore_file1_idx` (`original_file_id`),
  ADD KEY `fk_filestore_image_filestore_file2_idx` (`thumb_file_id`);
...
ALTER TABLE `landingresponse`
  ADD PRIMARY KEY (`id`),
  ADD KEY `campaign_id` (`campaign_id`) USING BTREE,
  ADD KEY `lead_id` (`contact_id`) USING BTREE,
...
--
-- Indexes for table `leave_template_detail`
--
ALTER TABLE `leave_template_detail`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `lodgement`
  ...
  ADD KEY `salesinvoice_id` (`salesinvoice_id`) USING BTREE;
...
ALTER TABLE `point_system`
  ADD PRIMARY KEY (`id`),
  ADD KEY `contact_id` (`contact_id`) USING BTREE,
  ADD KEY `landing_campaign_id` (`landing_campaign_id`) USING BTREE,
  ADD KEY `landing_content_id` (`landing_content_id`) USING BTREE,
...
--
-- Indexes for table `publish_schedule`
--
ALTER TABLE `publish_schedule`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `rule-options`
--
ALTER TABLE `rule-options`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `store_transaction_row_custom_field_value`
--
ALTER TABLE `store_transaction_row_custom_field_value`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `task`
  ADD PRIMARY KEY (`id`);
ALTER TABLE `task` ADD FULLTEXT KEY `task_title_full_text` (`task_name`,`description`,`status`,`type`);
...
--
-- Indexes for table `xshop_item_images`
--
ALTER TABLE `xshop_item_images`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_item_id` (`item_id`),
  ADD KEY `fk_customefieldvalue_id` (`customefieldvalue_id`),
  ADD KEY `fk_epan_id` (`epan_id`),
  ADD KEY `fk_item_image_id` (`item_image_id`);

--
-- Indexes for table `xshop_item_quantity_set_conditions`
--
ALTER TABLE `xshop_item_quantity_set_conditions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_quantityset_id` (`quantityset_id`),
  ADD KEY `fk_custom_field_value_id` (`custom_field_value_id`),
  ADD KEY `fk_item_id` (`item_id`),
  ADD KEY `fk_customfield_id` (`customfield_id`),
  ADD KEY `fk_department_phase_id` (`department_phase_id`);
...
--
ALTER TABLE `activity`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9975;
--
...
--
ALTER TABLE `communication`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12444;
--
...
--
ALTER TABLE `contact_info`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3612;
--
...
ALTER TABLE `discount_voucher_used`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `dispatch_barcode`
--
ALTER TABLE `dispatch_barcode`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `employee_attandance`
--
ALTER TABLE `employee_attandance`
...
ALTER TABLE `employee_leave`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `employee_leave_allow`
--
ALTER TABLE `employee_leave_allow`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `leave_template`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `leave_template_detail`
--
ALTER TABLE `leave_template_detail`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `publish_schedule`
--
ALTER TABLE `publish_schedule`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `qsp_detail`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56524;
--
...
--
-- AUTO_INCREMENT for table `rule-options`
--
ALTER TABLE `rule-options`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `store_transaction_row`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `store_transaction_row_custom_field_value`
--
ALTER TABLE `store_transaction_row_custom_field_value`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `xmarketingcampaign_googlebloggerconfig`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `xshop_item_images`
--
ALTER TABLE `xshop_item_images`
