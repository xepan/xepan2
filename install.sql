...
) ENGINE=InnoDB AUTO_INCREMENT=12553 DEFAULT CHARSET=utf8;
...
CREATE TABLE `communication` (
  ...
  `related_2_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `related_document_id` (`related_document_id`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=17058 DEFAULT CHARSET=utf8;
...
CREATE TABLE `lead_category_association` (
  ...
  KEY `marketing_category_id` (`marketing_category_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=19392 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=457 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT;
