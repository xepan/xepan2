...
$.widget("ui.atk4_checkboxes", {
	_init: function(options){
		...
		// this.element.find('tbody td:first-child').selectable({filter: 'td:first-child',stop: function(){ chb.stop.apply(chb,[this]) }}).css({cursor:'crosshair'});				
		this.element.find('tbody td:first-child').selectable({filter: 'tr',stop: function(){ chb.stop.apply(chb,[this]) }}).css({cursor:'crosshair'});
