<?php  //[STAMP] 154c8fb294d978a74ee547ab3cd08c42
...
trait VisitorActions
{
     ...
     * @see \Helper\Select2::waitForSelect2()
     */
    public function waitForSelect2($selector, $timeout = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('waitForSelect2', func_get_args()));
    }
     ...
     * @param int $timeout seconds. Default to 5
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Helper\Select2::dontSeeOptionIsSelectedForSelect2()
     */
    public function cantSeeOptionIsSelectedForSelect2($selector, $optionText, $timeout = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('dontSeeOptionIsSelectedForSelect2', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Helper\Select2::dontSeeOptionIsSelectedForSelect2()
     */
    public function dontSeeOptionIsSelectedForSelect2($selector, $optionText, $timeout = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('dontSeeOptionIsSelectedForSelect2', func_get_args()));
    }
     ...
     * @param int $timeout seconds. Default to 5
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Helper\Select2::seeOptionIsSelectedForSelect2()
     */
    public function canSeeOptionIsSelectedForSelect2($selector, $optionText, $timeout = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeOptionIsSelectedForSelect2', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Helper\Select2::seeOptionIsSelectedForSelect2()
     */
    public function seeOptionIsSelectedForSelect2($selector, $optionText, $timeout = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeOptionIsSelectedForSelect2', func_get_args()));
    }
     ...
     * @see \Helper\Select2::selectOptionForSelect2()
     */
    public function selectOptionForSelect2($selector, $option, $timeout = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('selectOptionForSelect2', func_get_args()));
    }
     ...
     * @param $option
     * @param int $timeout seconds. Default to 1
     * @see \Helper\Select2::unselectOptionForSelect2()
     */
    public function unselectOptionForSelect2($selector, $option = null, $timeout = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('unselectOptionForSelect2', func_get_args()));
    }
     ...
     * @see \Helper\Select2::openSelect2()
     */
    public function openSelect2($selector) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('openSelect2', func_get_args()));
    }
     ...
     * @param string $selector
     * @see \Helper\Select2::closeSelect2()
     */
    public function closeSelect2($selector) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('closeSelect2', func_get_args()));
    }
}
